...
def setup():
  ...
  from locations.models import Location, BuildingType
  bar = BuildingType.objects.create(name='music bar', category='venue with stage')
  venue = Location.objects.create(building_type=bar, name="Bojo's", genre_id=1, brand_id=2)

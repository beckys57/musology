...
def setup():
  ...
  erb3, _ = Person.objects.get_or_create(**{"happiness": 1, "name": "Rosemary Erb", "genre_id": 1,  "job_id": musician_job.id, "hair_style": "2", "skin_color": "#d7ad93", "hair_color": "#495919"})
  erb4, _ = Person.objects.get_or_create(**{"happiness": 1, "name": "Thyme Erb", "genre_id": 1,  "job_id": musician_job.id, "hair_style": "3", "skin_color": "#d7ad93", "hair_color": "#495919"})
  ...
  Location.objects.get_or_create(brand_id=1, building_type=pub, name="Ye Olde 'Ole", district_id=cotham.id, genre_id=int(cotham.crowds_in_size_order[0]["genre_id"]), latitude="51.4697231", longitude="-2.6136605", capacity=30)

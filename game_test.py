...
def setup():
  ...
  erb1, _ = Person.objects.get_or_create(**{"name": "Parsley Erb", "genre_id": 1,  "job_id": musician_job.id, "hair_style": "2", "skin_color": "#d7ad93", "hair_color": "#495919"})
  erb2, _ = Person.objects.get_or_create(**{"name": "Sage Erb", "genre_id": 1,  "job_id": musician_job.id, "hair_style": "2", "skin_color": "#d7ad93", "hair_color": "#495919"})
  erb3, _ = Person.objects.get_or_create(**{"name": "Rosemary Erb", "genre_id": 1,  "job_id": musician_job.id, "hair_style": "2", "skin_color": "#d7ad93", "hair_color": "#495919"})
  erb4, _ = Person.objects.get_or_create(**{"name": "Thyme Erb", "genre_id": 1,  "job_id": musician_job.id, "hair_style": "3", "skin_color": "#d7ad93", "hair_color": "#495919"})

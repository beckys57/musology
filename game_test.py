...
def setup():
  ...
  pubvenue, _ = Location.objects.get_or_create(building_type=pub, name="Ye Olde 'Ole", district_id=knowle.id, genre_id=int(knowle.crowds_in_size_order[0]["genre_id"]), latitude="51.4380286", longitude="-2.5738362", capacity=80)
